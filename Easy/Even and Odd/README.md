...
<p style=""><span style="font-size:18px"><strong>Example 1:</strong></span></p>

<pre style=""><span style="font-size:18px"><strong>Input:
</strong>N = 6
arr[] = {3, 6, 12, 1, 5, 8}
...
<div style=""><span style="font-size:18px"><strong>Example 2:</strong></span></div>
...
<p style="cursor: default;" title=""><br>
